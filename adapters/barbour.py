"""
Adapter for Barbour's sale section.
...
This source only carries Barbour, so brand is fixed.
"""
from bs4 import BeautifulSoup
from adapters.base import safe_get

SALE_URL = "https://www.barbour.com/us/sale/mens"
SOURCE_NAME = "Barbour"
BRAND_NAME = "Barbour"
...
def fetch_deals() -> list:
    ...
    for tile in soup.select(".product-tile"):  # ADJUST ME
        try:
            ...
            print(f"[barbour] skipped a tile due to parse error: {e}")
            continue
