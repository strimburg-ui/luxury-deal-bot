"""
Adapter for Bills Khakis's sale section.

Bills Khakis runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://billskhakis.com/collections/sale/products.json
...
BASE_URL = "https://billskhakis.com"
COLLECTION_HANDLE = "sale"
SOURCE_NAME = "Bills Khakis"
BRAND_NAME = "Bills Khakis"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[bills_khakis] page {page} did not return valid JSON")
            break
    ...
    print(f"[bills_khakis] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
