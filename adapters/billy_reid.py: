"""
Adapter for Billy Reid's sale section.

Billy Reid runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://www.billyreid.com/collections/mens-sale/products.json
...
BASE_URL = "https://www.billyreid.com"
COLLECTION_HANDLE = "mens-sale"
SOURCE_NAME = "Billy Reid"
BRAND_NAME = "Billy Reid"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[billy_reid] page {page} did not return valid JSON")
            break
    ...
    print(f"[billy_reid] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
