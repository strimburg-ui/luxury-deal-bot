"""
Adapter for Faherty's sale section.

Faherty runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://www.fahertybrand.com/collections/mens-sale/products.json
...
BASE_URL = "https://www.fahertybrand.com"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[faherty] page {page} did not return valid JSON")
            break
    ...
    print(f"[faherty] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
