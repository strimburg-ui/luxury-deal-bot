"""
Adapter for Grayers's sale section.

Grayers runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://www.grayers.com/collections/sale/products.json
...
BASE_URL = "https://www.grayers.com"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[grayers] page {page} did not return valid JSON")
            break
    ...
    print(f"[grayers] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
