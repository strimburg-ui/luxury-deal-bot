"""
Adapter for J.Crew's sale section.
...
This source only carries J.Crew, so brand is fixed.
"""
from bs4 import BeautifulSoup
from adapters.base import safe_get

SALE_URL = "https://www.jcrew.com/plp/mens/sale"
SOURCE_NAME = "J.Crew"
BRAND_NAME = "J.Crew"
...
def fetch_deals() -> list:
    ...
    for tile in soup.select(".product-tile"):  # ADJUST ME
        try:
            ...
            print(f"[jcrew] skipped a tile due to parse error: {e}")
            continue
