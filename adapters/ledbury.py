"""
Adapter for Ledbury's sale section.

Ledbury runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://www.ledbury.com/collections/sale/products.json
...
BASE_URL = "https://www.ledbury.com"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[ledbury] page {page} did not return valid JSON")
            break
    ...
    print(f"[ledbury] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
