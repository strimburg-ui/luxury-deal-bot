"""
Adapter for Nordstrom Rack's sale section.
...
SALE_URL = "https://www.nordstromrack.com/clothing/mens"
SOURCE_NAME = "Nordstrom Rack"
...
def fetch_deals() -> list:
    ...
    for tile in soup.select(".product-tile"):  # ADJUST ME
        try:
            ...
            print(f"[nordstrom_rack] skipped a tile due to parse error: {e}")
            continue
