"""
Adapter for Polo Ralph Lauren's sale section.
...
This source only carries Polo Ralph Lauren, so brand is fixed.
"""
from bs4 import BeautifulSoup
from adapters.base import safe_get

SALE_URL = "https://www.ralphlauren.com/men-sale"
SOURCE_NAME = "Polo Ralph Lauren"
...
def fetch_deals() -> list:
    ...
    for tile in soup.select(".product-tile"):  # ADJUST ME
        try:
            ...
            print(f"[polo_ralph_lauren] skipped a tile due to parse error: {e}")
            continue
