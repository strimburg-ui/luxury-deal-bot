"""
Adapter for Southern Tide's sale section.

Southern Tide runs on Shopify, which publishes a free public JSON feed of every
...
Feed used: https://southerntide.com/collections/mens-sail-shop/products.json
...
BASE_URL = "https://southerntide.com"
COLLECTION_HANDLE = "mens-sail-shop"
SOURCE_NAME = "Southern Tide"
BRAND_NAME = "Southern Tide"
...
def fetch_deals() -> list:
    ...
    while page <= max_pages:
        ...
        try:
            ...
            print(f"[southern_tide] page {page} did not return valid JSON")
            break
    ...
    print(f"[southern_tide] parsed {len(deals)} products across {page - 1} page(s)")
    return deals
