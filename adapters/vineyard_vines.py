"""
Adapter for Vineyard Vines's sale section.
...
This source only carries Vineyard Vines, so brand is fixed.
"""
from bs4 import BeautifulSoup
from adapters.base import safe_get

SALE_URL = "https://www.vineyardvines.com/pages/mens-sale"
SOURCE_NAME = "Vineyard Vines"
BRAND_NAME = "Vineyard Vines"
...
def fetch_deals() -> list:
    ...
    for tile in soup.select(".product-tile"):  # ADJUST ME
        try:
            ...
            print(f"[vineyard_vines] skipped a tile due to parse error: {e}")
            continue
